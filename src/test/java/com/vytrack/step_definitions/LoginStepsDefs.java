...
public class LoginStepsDefs {
    ...
    public void the_user_enters_the_sales_manager_information() {
        ...
        String dUsername=ConfigurationReader.get("sales_manager_username");
        String dPassword=ConfigurationReader.get("sales_manager_password");
        LoginPage loginPage=new LoginPage();
        loginPage.login(dUsername,dPassword);
    ...
    public void the_user_enters_the_store_manager_information() {
        ...
        String dUsername=ConfigurationReader.get("store_manager_username");
        String dPassword=ConfigurationReader.get("store_manager_password");
        LoginPage loginPage=new LoginPage();
        loginPage.login(dUsername,dPassword);
